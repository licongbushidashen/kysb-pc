  ...
  >
    <flexbox class="approval-flow__hd" justify="space-between">
      <div class="approval-flow__hd--left">
        <span class="flow-title"> <i class="wk wk-approve" />审批流信息 </span>

        <el-popover v-model="showFlowPopover" width="300" trigger="click">
          <check-flow
            ref="checkFlow"
    ...
    <flexbox class="check-items" wrap="wrap">
      ...
      >
        ...
        <flexbox slot="reference" class="check-item">
          <img
