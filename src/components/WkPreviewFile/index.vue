  ...
  >
    ...
    <div ref="imgContainer" class="imgContainer">
      <img
        ...
        @mousedown="addMove"
      >
      <div v-if="!bigShowType.isImage" class="file-show">
        <div v-if="!showPreviewBtn" class="title">
          该附件格式不支持预览，请下载后查看
        </div>
        <i class="el-icon-close" @click="closeViewer" />
        <div class="content">
          <img :src="bigShowType.icon" class="file-icon" >
          <div class="file-handle">
            ...
            >
            <el-button
              type="primary" @click.native="downloadFile"
            >下载</el-button
            >
          </div>
        </div>
    ...
    <div class="fixedHandle">
      ...
      <flexbox v-if="bigShowType.isImage" class="handleContainer">
        <div class="handle-box">
          <i class="wk wk-zoom-in" @click="enlarge" />
          <i class="wk wk-zoom-on" @click="reduce" />
          <i class="wk wk-rotate" @click="rotate" />
          <i class="wk wk-download" @click="downloadFile" />
        </div>
      ...
      <div v-if="imgLength > 1" class="thumbnailContainer">
        <ul>
          ...
          >
            <img v-src="item.url" v-if="isShowImage(item.name)" alt="" >
            <img v-else :src="getFileTypeIconWithSuffix(item.name)" alt="" >
          </li>
        </ul>
      </div>
    </div>
...
export default {
  ...
  methods: {
     ...
     */
    downloadFile() {
      downloadFileAPI(this.currentFile.url)
        .then(res => {
