<template>
  <div class="login-by-pwd">
    ...
    <div class="control">
      <div class="btn" @click="debouncedHandleLogin">
        登&nbsp;录
      </div>
    </div>
  </div>
...
export default {
  ...
  created() {
    ...
    //     password: '*',
    //     grant_type: 'password',
    //     client_id: 'IdentityMindService',
    //     client_secret: '1q2w3e*'
    //   }
    // } else if (this.$route.query.username) {
    //   this.form = {
    //     username: this.$route.query.username || 'admin',
    //     password: this.$route.query.password || '1q2w3E*',
    //     grant_type: 'password',
    //     client_id: 'IdentityMindService',
    //     client_secret: '1q2w3e*'
    //   }
