  ...
  <div v-loading="loading">
    ...
    <div class="product-setting">
      ...
      <div class="product-setting-con">
        <div>
          <span class="el-icon-plus" style="color: #409EFF;" />
          <el-button
            type="text"
            @click.native="handleTreeSetDrop({ type: 'create-one' })"
          >新增一级分类</el-button
          >
        </div>
        <div class="tree-box">
          <el-tree :data="treeData" :props="defaultProps" default-expand-all>
            <flexbox slot-scope="{ node, data }" class="node-data">
              <img
                v-if="node.expanded"
                class="node-img"
              ...
              >
                <div class="node-label-set" @click.stop="getChild(node)">
                  设置
                </div>
    ...
    >
      <el-form :model="productForm">
        <el-form-item label="类别名称" label-width="80">
          <el-input
            :maxlength="20"
