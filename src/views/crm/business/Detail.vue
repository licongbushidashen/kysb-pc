  ...
  >
    <div v-loading="loading" ref="crmDetailMain" class="detail-main">
      ...
      >
        ...
        <div v-if="status.length > 0" class="busi-state-main">
          <flexbox
          ...
          >
            <a v-for="(item, index) in status" :key="index">
              ...
              >
                ...
                >
                  {{ item.name }}
                  <div v-if="index == 0" class="state-circle circle-left" />
                  <div v-if="index != 0" class="state-arrow arrow-left" />
              ...
              <el-popover
                ...
                trigger="hover"
              >
                <div v-if="item.type == 0" class="state-handel-cont">
                  <flexbox
                  ...
                  >
                    <img :src="item.img" class="state-handel-item-img" >
                ...
                <div
                  ...
                  class="busi-state-item"
                >
                  <i :class="item.overIcon" style="margin-right:8px;" />
                  {{ item.name }}
    ...
    <el-button
      class="firse-button" @click="showImportInfo = !showImportInfo"
    >重<br >要<br >信<br >息<br ><i
  ...
  computed: {
    ...
    tabNames() {
      ...
      if (this.crm.contacts && this.crm.contacts.index) {
        tempsTabs.push({
          label: this.getTabName('联系人', this.tabsNumber.contactCount),
      ...
      if (this.crm.contract && this.crm.contract.index) {
        tempsTabs.push({
          label: this.getTabName('合同', this.tabsNumber.contractCount),
      ...
      if (this.crm.product && this.crm.product.index) {
        tempsTabs.push({
          label: this.getTabName('产品', this.tabsNumber.productCount),
          name: 'RelativeProduct'
        })
      }

      tempsTabs.push({
        label: this.getTabName('团队成员', this.tabsNumber.memberCount),
        name: 'RelativeTeam'
      })
      tempsTabs.push({
